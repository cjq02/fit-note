            ...
            <div className="mb-6">
                ...
                <Grid columns={3} gap={8}>
                    {quickActions.map((action, index) => (
                        <Grid.Item key={index}>
                            <Card onClick={action.onClick} className="text-center hover:shadow-md transition-shadow active:bg-gray-50">
                ...
                <Card className="hover:shadow-md transition-shadow">
                    <Space direction="vertical" style={{ width: '100%' }}>
                        ...
                        <div className="flex gap-2 flex-wrap">
                            <span className="px-2 py-1 bg-[var(--adm-color-primary)] bg-opacity-10 text-[var(--adm-color-primary)] text-xs rounded">卧推</span>
                            <span className="px-2 py-1 bg-[var(--adm-color-primary)] bg-opacity-10 text-[var(--adm-color-primary)] text-xs rounded">深蹲</span>
                            <span className="px-2 py-1 bg-[var(--adm-color-primary)] bg-opacity-10 text-[var(--adm-color-primary)] text-xs rounded">硬拉</span>
                        </div>
                    </Space>
                </Card>
            </div>
